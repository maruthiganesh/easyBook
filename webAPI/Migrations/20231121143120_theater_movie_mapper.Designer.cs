...
namespace webAPI.Migrations
{
    ...
    [Migration("20231121143120_theater_movie_mapper")]
    partial class theater_movie_mapper
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webAPI.Models.Theater_Movie_mapper", b =>
                {
                    ...
                    b.ToTable("Theater_Movie_Mappers");
                });
            ...
            modelBuilder.Entity("webAPI.Models.Theater_Movie_mapper", b =>
                {
                    b.HasOne("webAPI.Models.Movies", "Movies")
                        .WithOne("Theater_Movie_Mapper")
                        .HasForeignKey("webAPI.Models.Theater_Movie_mapper", "Movie_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("webAPI.Models.Theater", "Theater")
                        .WithOne("Theater_Movie_Mapper")
                        .HasForeignKey("webAPI.Models.Theater_Movie_mapper", "Theater_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("webAPI.Models.Movies", b =>
                {
                    ...
                    b.Navigation("Theater_Movie_Mapper")
                        .IsRequired();
                });
